...
@section('content')
    <form class="mb-5 grid gap-3 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm md:grid-cols-[1fr_180px_auto]" data-live-search data-live-target="#projects-grid" data-live-partial="1">
    ...
    <div id="projects-grid">
        @include('projects._grid', ['projects' => $projects])
    </div>
@endsection
