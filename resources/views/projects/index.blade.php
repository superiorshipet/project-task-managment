...
@section('content')
    <form class="mb-5 grid gap-3 rounded-2xl border border-gray-200 bg-white p-3 shadow-sm sm:p-4 md:grid-cols-[1fr_180px_180px_auto]" data-live-search data-live-target="#projects-grid" data-live-partial="1">
        <input name="q" value="{{ request('q') }}" placeholder="Search by title or description" class="min-w-0 rounded-xl border border-gray-200 px-4 py-2.5 outline-none transition focus:border-indigo-400">
        ...
        <select name="favorite" class="min-w-0 rounded-xl border border-gray-200 px-4 py-2.5 outline-none transition focus:border-indigo-400">
